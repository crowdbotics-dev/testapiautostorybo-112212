...
## Project Structure
    ...
    ├── testapiautostorybo_112212  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112212`
...
2. Clone this repo and `cd testapiautostorybo_112212`
